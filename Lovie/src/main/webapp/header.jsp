			...
			<div class="collapse navbar-collapse"
				...
				<sec:authorize access="hasRole('ROLE_ADMIN') or hasRole('ROLE_GOLD') or hasRole('ROLE_USER')">
					...
					<div class="member_nav" style="float:right">
						<div>
							<a href='${pageContext.request.contextPath}/MemberPersonalPage/${loginmember.id}'> <img src=${pageContext.request.contextPath}/photo/member/${loginmember.id} height="40" /></a>
