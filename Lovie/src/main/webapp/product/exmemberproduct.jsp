	...
	<div class="shop">
		...
		<div class="container">
			...
			<div class="col-md-3">
				...
				<div class="list-group">
					...
					<a href="/Lovie/product.do" class="list-group-item">回商城首頁</a> <a
						href="../product/movieproduct.jsp" class="list-group-item">電影週邊商品</a> <a href="#"
			...
			<div class="col-md-9">
				...
				<div class="col-md-6">
					<div class="thumbnail">
						<img src="../cart/images001.jpg" alt="">
						<div class="caption">
							<p>紅寶石會員</p>
							<p>
								<a href="#" class="btn btn-primary">加入購物車</a>
				...
				<div class="col-md-6">
					<div class="thumbnail">
						<img src="../cart/images004.jpg" alt="">
						<div class="caption">
							<p>鑽石會員</p>
							<p>
								<a href="#" class="btn btn-primary">加入購物車!</a>
				...
				<div class="col-md-6">
					<div class="thumbnail">
						<img src="../cart/images005.jpg" alt="">
						<div class="caption">
							<p>初等會員</p>
							<p>
								<a href="#" class="btn btn-primary">加入購物車</a>
