...
<form>
  ...
  <div class="col-md-9" ><b class="memberColumn">星座：</b>${memberConstellation}</div>
  ...
  <div class="col-md-2" ><button  style="display:none">套用</button></div>
  <div class="col-md-12" ><br></div>
...
if("${loginmember.id}"=="${oneMember.id}"){
