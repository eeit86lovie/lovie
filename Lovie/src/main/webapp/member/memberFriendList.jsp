	...
	$.ajax({
		...
		success:function(memberBean){
			...
			$.each(memberBean,function(idx,member){	
				...
				var last=$("<div class='col-sm-12' ></div><div class='col-sm-8' ></div>")
				var lastOnTime=$("<div class='col-sm-4' ></div>").append("上站時間："+member.lastOnTime)
				var row = $("<div class='row'></div>").append([img2,nickname,city,age,intro1,movieList,line,addFriend,removeFriend,last,lastOnTime,hr])
				flag.append(row)
			})
			tb.append(flag)
